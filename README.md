...
<i>Sayita daxil olduqdan sonra bu (dotnet new sln --name MySolution) yazilisi tapib isdifade ede bilerik. </i><br/> 12.<b>Axdaris yerine dotnet new sln --name MySolution</b>-yazdiqda asagidaki sekili tapmaq lazimdir.<br/>
<a herf="https://learn.microsoft.com/en-us/dotnet/core/tools/dotnet-sln">saaalmm</a>
