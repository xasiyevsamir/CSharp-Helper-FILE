...
4. <a herf="https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/">C# da acar sozlere baxmaq !</a>
5. <a herf=" http://www.java2s.com/Tutorial/CSharp/CatalogCSharp.htm">C# ders sayiti !</a>
6. <a herf="http://extraconversion.com/base-number">Say sisteminin cevrilisi!</a>
